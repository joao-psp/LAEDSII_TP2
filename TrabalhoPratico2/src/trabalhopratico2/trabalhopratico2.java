...
public class trabalhopratico2 {
    ...
    public static void main(String[] args) {
        ...
        Linha2.LinhaMontageDinamica(a3,a4,t3,t4,e3,e4,x3,x4);
        
        System.out.println();
        System.out.println("-----------------PROBLEMA 1 GULOSO----------");
        System.out.println();
            
        Guloso Linha1Guloso = new Guloso();
        Linha1Guloso.LinhaMontagemGuloso(a1,a2,t1,t2,e1,e2,x1,x2);
        
        System.out.println();
        System.out.println("-----------------PROBLEMA 2 GULOSO----------");
        System.out.println();
        
        Guloso Linha2Guloso = new Guloso();
        Linha2Guloso.LinhaMontagemGuloso(a3,a4,t3,t4,e3,e4,x3,x4);
